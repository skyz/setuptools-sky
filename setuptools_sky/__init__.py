...
PRETEND_KEY = 'SETUPTOOLS_SKY_PRETEND_VERSION'


TEMPLATES = {
    '.py': """\
# coding: utf-8
# file generated by setuptools_sky
...
def version_from_scm(root):
    return _version_from_entrypoint(root, 'setuptools_sky.parse_scm')
...
def _do_parse(root, parse):
    ...
    if parse:
        ...
        version = parse_result or _version_from_entrypoint(
            root, 'setuptools_sky.parse_scm_fallback')
    else:
